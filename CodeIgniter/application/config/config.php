...
|
*/
$config['base_url'] = 'http://localhost/FinalProject/CodeIgniter/';
...
*/
// $config['proxy_ips'] = '';$config['useragent']        = 'PHPMailer';              // Mail engine switcher: 'CodeIgniter' or 'PHPMailer'
...
// $config['smtp_user']        = '99f23668183f66';
// $config['smtp_pass']        = 'ce1183f6334e67';
