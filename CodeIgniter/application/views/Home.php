								...
								<div class="col-sm-4 w3-ab">
									<div class="w3-ab-grid text-center">
										<div class="w3-aicon p-4">
											...
											<a href="<?php echo site_url('/our-doctors');?>?departmentSelector=7">
								...
								<div class="col-sm-4 w3-ab">
									<div class="w3-ab-grid text-center">
										<div class="w3-aicon p-4">
											...
											<a href="<?php echo site_url('/our-doctors');?>?departmentSelector=9">
								...
								<div class="col-sm-4 w3-ab">
									<div class="w3-ab-grid text-center">
										<div class="w3-aicon p-4">
											...
											<a href="<?php echo site_url('/our-doctors');?>?departmentSelector=10">
								...
								<div class="col-sm-4 mt-4 w3-ab">
									<div class="w3-ab-grid text-center">
										<div class="w3-aicon  p-4">
											...
											<a href="<?php echo site_url('/our-doctors');?>?departmentSelector=1">
								...
								<div class="col-sm-4 mt-4 w3-ab">
									<div class="w3-ab-grid text-center">
										<div class="w3-aicon p-4">
											...
											<a href="<?php echo site_url('/our-doctors');?>?departmentSelector=26">
